...
APPLICATION_INFRASTRUCTURE_DEBT = {
    "audio_studio.application.activity -> audio_studio.infrastructure.postgres.activity.ActivityRepository",
    "audio_studio.application.administration -> audio_studio.infrastructure.media_paths.media_root",
    ...
    "audio_studio.application.media -> audio_studio.infrastructure.postgres.media.MediaLookupRepository",
    "audio_studio.application.renders -> audio_studio.infrastructure.media_paths.media_root",
    "audio_studio.application.renders -> audio_studio.infrastructure.postgres.exports.ProductionExportRepository",
    "audio_studio.application.renders -> audio_studio.infrastructure.postgres.production_document.MUSIC_LEVELS",
    "audio_studio.application.renders -> audio_studio.infrastructure.postgres.production_document.ProductionDocumentRepository",
    "audio_studio.application.renders -> audio_studio.infrastructure.postgres.transcripts.TranscriptRepository",
    "audio_studio.application.renders -> audio_studio.infrastructure.postgres.work",
    "audio_studio.application.settings -> audio_studio.infrastructure.media_paths.media_root",
    "audio_studio.application.settings -> audio_studio.infrastructure.object_storage",
    "audio_studio.application.settings -> audio_studio.infrastructure.postgres.control_plane.ControlPlaneRepository",
    "audio_studio.application.speech -> audio_studio.infrastructure.audio_workspace.SavedAudio",
    "audio_studio.application.system -> audio_studio.infrastructure.postgres.control_plane.ControlPlaneRepository",
    "audio_studio.application.system -> audio_studio.infrastructure.postgres.worker_runtime.WorkerRuntimeRepository",
    ...
    "audio_studio.application.work -> audio_studio.infrastructure.postgres.venture_assets.VentureAssetRepository",
...
HTTP_INFRASTRUCTURE_DEBT = {
    ...
    "audio_studio.http.routers.jobs -> audio_studio.infrastructure.postgres.jobs.JobRepository",
    "audio_studio.http.routers.settings -> audio_studio.infrastructure.object_storage",
...
TRANSITIONAL_MODULE_DEBT = {
    ...
    "audio_studio.application.batches -> batch",
    "audio_studio.application.catalog -> batch",
    ...
    "audio_studio.application.settings -> services.alibaba.config",
    "audio_studio.application.transcription -> services.alibaba.pricing.transcription_cost",
    "audio_studio.application.transcription -> services.captions",
    "audio_studio.application.translation -> services.captions",
    "audio_studio.application.voices -> services.voice_packages",
    "audio_studio.http.routers.subtitles -> services.captions",
    "audio_studio.infrastructure.alibaba.speech_generation -> say",
    "audio_studio.infrastructure.alibaba.speech_generation -> services.alibaba.config",
    "audio_studio.infrastructure.alibaba.speech_generation -> services.alibaba.fidelity",
    "audio_studio.infrastructure.alibaba.speech_generation -> services.alibaba.pricing.PRICE_VERSION",
    "audio_studio.infrastructure.alibaba.speech_generation -> services.alibaba.pricing.qwen_audio_tts_cost",
    "audio_studio.infrastructure.alibaba.speech_generation -> services.alibaba.speech",
    "audio_studio.infrastructure.alibaba.speech_generation -> services.voice_routing",
    "audio_studio.infrastructure.alibaba.text_preparation -> services.alibaba.config",
    "audio_studio.infrastructure.alibaba.text_preparation -> services.alibaba.text",
    "audio_studio.infrastructure.alibaba.transcription -> services.alibaba.config",
    "audio_studio.infrastructure.alibaba.translation -> services.alibaba.config",
    "audio_studio.infrastructure.alibaba.translation -> services.alibaba.text",
...
SERVICES_MODULE_DEBT = {
    ...
    "services/alibaba/config.py",
    "services/alibaba/fidelity.py",
    "services/alibaba/omni.py",
    "services/alibaba/pricing.py",
