...
6. Migrate the remaining canonical Work lifecycle and Production editor,
   timeline, render and media persistence paths out of legacy `db.py` as each
   capability is touched. Voice identities, control-plane persistence, Venture
   Assets and voice package execution are native.
