...
from origins.config import alibaba_environment, settings
from origins.infrastructure import object_storage, runtime_environment
from origins.infrastructure.media_paths import media_root, voice_reference_root
...
class EnvironmentSettings:
    ...
    def provider(self) -> dict[str, Any]:
        ...
        return {
            ...
            "provider_workspace_id": environment.provider_workspace_id,
    ...
    def media_generation_provider(self) -> dict[str, Any]:
        ...
        return {
            ...
            "reason": "" if configured else (
                "Add the KIE API key before using KIE Media models."),
        }
    ...
    def save_provider(self, values: dict[str, Any]) -> None:
        changes: dict[str, str | None] = {
            ...
            "DASHSCOPE_WORKSPACE_ID": str(values.get("provider_workspace_id") or ""),
        }
