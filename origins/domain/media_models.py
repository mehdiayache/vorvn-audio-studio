...
def _kling_video_fields() -> list[dict[str, Any]]:
    return [
        ...
        _field(
            "elements", "file_list", "Characters & subjects", default=[],
...
MODELS: tuple[dict[str, Any], ...] = (
    {
        ...
        "status": "enabled",
        "presentation": {"brand_label": "Kling", "icon_url": "/origins/brands/kling.svg"},
...
def model_capability(
    ...
    raise ValueError("That model does not support the selected Media operation.")
