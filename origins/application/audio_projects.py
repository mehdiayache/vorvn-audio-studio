...
def project_scene(editor: dict, sound_scene: dict) -> dict:
    """Project -> Tracks -> Clips view of one playable Project."""
    position = 0.0
    clips = []
    ...
    if not clips:
        raise RenderError("That Project has no playable Clips.")
