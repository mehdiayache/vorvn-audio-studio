...
from origins.domain import (
    delivery_tags,
    naming,
    provider_catalog,
    speech_text,
)
from origins.domain import voice_registry, voice_routing
...
class CatalogService:
    ...
    def configuration(self) -> dict:
        ...
        return {
            ...
            "provider_workspace": {
                "configured": bool(environment.provider_workspace_id),
                "id": environment.provider_workspace_id,
