"""Commit exact Creation outputs as canonical Workspace Files."""
...
class CreationFileService:
    ...
    def register(
        ...
        if job.workspace_id is None:
            raise ValueError("Creation output Files require a Workspace-owned Job.")
        ...
        file, _duplicate = self.records.create_generated_workspace_file(
