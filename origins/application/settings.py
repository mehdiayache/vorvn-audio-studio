...
from origins.domain import naming, speech_text
...
class Configuration(Protocol):
    ...
    def media_generation_provider(self) -> dict[str, Any]: ...
    ...
    def save_media_generation_provider(self, values: dict[str, Any]) -> None: ...
...
class SettingsService:
    def __init__(self, *, control_plane: ControlPlane,
                 ...
                 media_generation_provider_connection_test: Callable[[], dict[str, Any]],
        ...
        self.media_generation_provider_connection_test = (
            media_generation_provider_connection_test)
    ...
    def snapshot(self) -> dict[str, Any]:
        ...
        return {
            ...
            "media_generation_provider": self.configuration.media_generation_provider(),
    ...
    def update(self, changes: dict[str, Any]) -> dict[str, Any]:
        ...
        if "output_directory" in changes:
            raise ValueError(
                ...
                "ORIGINS_OUTPUT_DIR before starting Origins."
            )
    ...
    def update_provider(self, values: dict[str, Any]) -> dict[str, Any]:
        ...
        self.configuration.save_provider({
            "region": region,
            "provider_workspace_id": str(values.get("provider_workspace_id") or "").strip(),
            "api_key": str(values.get("api_key") or "").strip(),
        })
        return self.snapshot()

    def update_media_generation_provider(
        self, values: dict[str, Any],
    ) -> dict[str, Any]:
        self.configuration.save_media_generation_provider({
            "api_key": str(values.get("api_key") or "").strip(),
    ...
    def test_media_generation_provider(self) -> dict[str, Any]:
        return self.media_generation_provider_connection_test()
