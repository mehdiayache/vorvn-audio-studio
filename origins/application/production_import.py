...
class ProductionImportJobHandler:
    ...
    def __init__(self, productions: ProductionCommands, timeline: TimelineService,
    ...
    def __call__(self, job: Job, progress: JobProgress) -> dict[str, Any]:
        ...
        try:
            ...
            if created:
                self.productions.delete_production(production_id)
            raise
    ...
    def _destination(self, destination: dict[str, Any], title: str,
        ...
        if destination.get("kind") == "existing":
            return self.productions.update_production(int(destination["production_id"]), {
                "name": title, "description": description,
            })
        return self.productions.create_audiovisual_production(
