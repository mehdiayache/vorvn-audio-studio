...
for action in (
    CreationAction(
        ...
        supported_contexts=("workspace", "audiovisual-project"), composer="speech",
    ),
    CreationAction(
        ...
        supported_contexts=("workspace", "audiovisual-project"), composer="music",
    ),
    CreationAction(
        ...
        parameters=(CreationField("duration", "Duration", "number", True),),
        output_mime_types=("audio/wav",),
        supported_contexts=("workspace", "audiovisual-project"), composer="sound-effect",
    ),
    CreationAction(
        ...
        supported_contexts=("workspace", "audiovisual-project"), composer="image",
    ),
    CreationAction(
        ...
        supported_contexts=("workspace", "audiovisual-project"), composer="video",
    ),
    CreationAction(
        ...
        supported_contexts=("workspace", "audiovisual-project"), composer="subtitles",
    ),
):
