...
class SoundPresetCompileRequest(BaseModel):
...
class SoundPresetConflictResponse(BaseModel):
    id: str
    title: str
    structured: str
    free_text: str
...
class SoundPresetCompileResponse(BaseModel):
    capability: str
    semantic_state: dict[str, Any]
    source_free_text: str
    compiled_prompt: str
    conflicts: list[SoundPresetConflictResponse]
    model: str
...
class SoundPresetCompileEnvelope(BaseModel):
    data: SoundPresetCompileResponse


class SoundPresetTaxonomyResponse(BaseModel):
    version: str
    items: list[dict[str, Any]]


class SoundPresetTaxonomyEnvelope(BaseModel):
    data: SoundPresetTaxonomyResponse
...
class AudioGenerationHistoryItemResponse(BaseModel):
    ...
    kept_file: UploadedFileResponse | None = None
