"""Public response contracts for machine and operational Settings."""
...
class MediaGenerationProviderSettingsResponse(BaseModel):
    name: str
    configured: bool
...
class SettingsSnapshotResponse(BaseModel):
    ...
    media_generation_provider: MediaGenerationProviderSettingsResponse
