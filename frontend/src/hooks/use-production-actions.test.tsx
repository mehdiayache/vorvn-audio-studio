...
const payload: GeneratePayload = {
  context: { workspace_id: 4, production_id: 28, production_type: "audiovisual", selection: { target: "script_part" } },
