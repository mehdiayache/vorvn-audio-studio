...
import { creatorCapabilityControls, resolvedDeliveryMode, selectedRouteCapability } from "./creator-capability"
...
describe("provider-neutral Creator capability controls", () => {
  it("derives controls from capability data without inspecting provider or engine", () => {
    ...
    const controls = creatorCapabilityControls(selected)
