 ...
 */
export function creatorTextFromPart(part?: ProductionPart | null): CreatorText {
...
export type CreatorOutput = { format: GeneratePayload["format"]; language: string }
...
export type CreatorTextPreparation = {
...
export type CompositionDraft = {
  ...
  text: CreatorText
  textPreparation: CreatorTextPreparation
  delivery: CreatorDelivery
