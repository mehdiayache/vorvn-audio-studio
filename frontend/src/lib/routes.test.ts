...
describe("Studio routes", () => {
  ...
  it("uses the Audio Studio root as a Venture directory", () => expect(studioRouteFromLocation("/audio-studio/", "")).toEqual({ type: "home", id: null }))
  ...
  it("keeps Activity inside Audio Studio", () => expect(studioRouteFromLocation("/audio-studio/activity", "")).toEqual({ type: "activity", id: null }))
