...
describe("operatorErrorMessage", () => {
  it("does not expose database internals as the operator message", () => {
    expect(operatorErrorMessage('ForeignKeyViolation: relation "clips" failed')).toBe("Audio Studio could not save this operation. Its technical record is available in Details.")
  })
