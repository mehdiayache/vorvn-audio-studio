...
describe("File provenance surface contract", () => {
  it.each(fixtures)("keeps Workspace Library, Project Library and Timeline aligned for %s", (_name, file) => {
    ...
    const projectLibrary = render(<VisualFileCard file={file} onPreview={vi.fn()} />)
    expect(sourceContract(projectLibrary.container)).toEqual(expectedContract)
    projectLibrary.unmount()
