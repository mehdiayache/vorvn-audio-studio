...
import { visualFileFacts, visualFileName, visualFilePlaybackUrl, visualFilePosterUrl, visualFileUrl } from "./visuals-files"

export function VisualFileCard({ file, mode = "visuals", pending = false, addLabel = "Add", usedCount = 0, onPreview, onAdd, onAddToTimeline, onRemove }: {
  file: WorkspaceFile
  mode?: "visuals" | "library"
  pending?: boolean
  addLabel?: string
  usedCount?: number
  ...
  const actionButtons = mode === "visuals" ? <>
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end">
        ...
        {onRemove && <><DropdownMenuSeparator /><DropdownMenuGroup><DropdownMenuItem onSelect={() => onRemove(file)}><X /> Remove from Visuals…</DropdownMenuItem></DropdownMenuGroup></>}
      </DropdownMenuContent>
    </DropdownMenu>
  </> : null
