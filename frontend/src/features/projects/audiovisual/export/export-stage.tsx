...
import { MixExportWorkspace } from "@/features/projects/audiovisual/support/mix-export-workspace"
import type { ProjectHealthIssue } from "@/features/projects/audiovisual/support/project-health-sheet"
  ...
  return <Dialog open={open} onOpenChange={onOpenChange}>
    <DialogContent className="ws-export-dialog" aria-describedby="ws-export-description">
      <DialogHeader className="ws-export-dialog-header">
        <DialogTitle>Export {workspaceProps.project.name}</DialogTitle>
