...
describe("TimelinePreview", () => {
  it("keeps the production format in Timeline Preview without exposing clip fit mechanics", () => {
    ...
    fireEvent.pointerDown(screen.getByRole("button", { name: "Project format 16:9" }), { button: 0, ctrlKey: false })
  ...
  it("keeps Timeline Preview controls inside a stable pane", () => {
    ...
    expect(screen.getByRole("button", { name: /Project format/ })).toBeTruthy()
