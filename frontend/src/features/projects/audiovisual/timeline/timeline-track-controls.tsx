...
export function TimelineTrackControls({ audioSession, visualSession, audioTracks, engineTracks, visualTracks, files, collapsed, soloTrackIds, sequenceSummary, onCollapsedChange, onAddAudio, onAddVisual, onRemoveAudioTrack, onRemoveVisualTrack }: {
