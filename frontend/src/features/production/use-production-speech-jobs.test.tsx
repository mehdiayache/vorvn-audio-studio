...
import { useProductionSpeechJobs } from "./use-production-speech-jobs"
...
describe("useProductionSpeechJobs", () => {
  it("announces one concise toast when an observed recording becomes ready", async () => {
    ...
    vi.spyOn(studioApi, "job").mockResolvedValue(ready)
    const refresh = vi.fn().mockResolvedValue(undefined)

    renderHook(() => useProductionSpeechJobs([part], refresh))
