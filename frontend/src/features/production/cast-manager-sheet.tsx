...
export function CastManagerSheet({ open, production, cast, directory, onOpenChange, onChanged }: {
  ...
  async function createRole() {
    ...
    try {
      ...
      setName(""); setPersonaId("none"); setAssignment("")
      await onChanged()
  ...
  return <Sheet open={open} onOpenChange={onOpenChange}><SheetContent className="cast-manager-sheet"><SheetHeader><SheetTitle>Production Cast</SheetTitle><SheetDescription>Owned roles choose a Voice Identity only. Their exact recording method is chosen later in the Composer; catalogue roles keep their exact catalogue voice.</SheetDescription></SheetHeader>
    <div className="cast-manager-body">
