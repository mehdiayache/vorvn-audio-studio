  ...
  return <div className="part-inspector-content" data-part-kind={part.kind}>
        <Tabs value={tab} onValueChange={changeTab} className="part-inspector-tabs">
          ...
          <ScrollArea className="part-inspector-scroll">
            <TabsContent value="script"><PartInspectorScript part={part} directory={directory} currentPlaying={playerPlaying && playingKey === `part:${part.id}`} roleBusy={data.roleBusy} onSaveRole={data.saveRole} onPlay={onPlay} onRecordPart={onRecordPart} onDuplicate={onDuplicate} onDelete={onDelete} /></TabsContent>
