import { AudioLines, FileAudio, Mic2, Search, SlidersHorizontal, Timer } from "lucide-react"

import { CommandDialog, CommandEmpty, CommandGroup, CommandInput, CommandItem, CommandList } from "@/components/ui/command"
import { clipText } from "@/lib/format"
import type { ProductionPart } from "@/types/domain"

export function ProductionCommandMenu({ open, parts, productionPlaying, onOpenChange, onAddSpeech, onAddSilence, onAddAsset, onPreview, onRelease, onLocate }: {
  open: boolean
