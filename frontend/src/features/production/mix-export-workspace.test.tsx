...
const soundScene = { production_id: 6, revision: 1, document: { version: 1, sequence_overrides: {}, tracks: [{ id: "music", kind: "audio", name: "Music", volume: 1, muted: false, clips: [] }] }, can_undo: false, can_redo: false, updated_at: "2026-08-18", resolved: { version: 1, signature: "scene", duration_ms: 2_000, sequence_projection: { signature: "sequence", duration_ms: 2_000, sample_rate: 48_000, spans: [] }, tracks: [{ id: "music", kind: "audio", name: "Music", volume: 1, muted: false, clips: [] }], orphans: [] }, sequence_stem: { url: "/audio/stem.mp3", filename: "stem.mp3", duration_ms: 2_000, signature: "sequence", cached: true } } as SoundScene
const visualScene = { production_id: 6, revision: 1, updated_at: "2026-08-27", document: { version: 1, canvas: { width: 1920, height: 1080 }, tracks: [{ id: "video", name: "Video", media_type: "video", visible: true, locked: false, clips: [{ id: "b73bb44a-c8be-4e67-9b65-a554611161a3", asset_id: 91, start_ms: 0, duration_ms: 2000, source_offset_ms: 0, fit: "cover", locked: false }] }] } } as VisualScene
