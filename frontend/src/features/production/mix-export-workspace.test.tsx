...
const soundScene = { production_id: 6, revision: 1, document: { version: 1, tracks: [{ id: "music", kind: "music", name: "Music", muted: false, clips: [] }] }, can_undo: false, can_redo: false, updated_at: "2026-08-18", resolved: { version: 1, signature: "scene", voice_projection: { signature: "voice", duration_ms: 2_000, sample_rate: 48_000, spans: [] }, tracks: [{ id: "music", kind: "music", name: "Music", muted: false, clips: [] }], orphans: [] }, voice_stem: { url: "/audio/stem.mp3", filename: "stem.mp3", duration_ms: 2_000, signature: "voice", cached: true } } as SoundScene
