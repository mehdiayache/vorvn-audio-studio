...
describe("ProductionMusicLane", () => {
  it("stays compact and makes the parallel Music state explicit", () => {
    ...
    expect(screen.getByText(/bed\.wav · 1:30/)).toBeTruthy()
    expect(screen.getByText("Preview update needed")).toBeTruthy()
    fireEvent.click(screen.getByRole("button", { name: "Edit Music Bed" }))
