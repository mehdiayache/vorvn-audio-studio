...
export function TimelineZoom({ index, maximum, pixelsPerSecond, onChange, onFit }: {
  ...
  return <div className="sound-scene-zoom-dock" aria-label="Timeline view controls">
    ...
    <OperatorTooltip label="Fit the entire Production in view"><Button variant="ghost" size="sm" onClick={onFit} aria-label="Fit entire timeline"><Maximize2 /><span>Fit</span></Button></OperatorTooltip>
  </div>
}
