...
export function SubtitlesPage() {
  ...
  const translate = async () => {
    ...
    try {
      const result = await studioApi.translateTranscript(transcript.id, translationLanguage)
      setTranscript(result); await refresh()
      toast.success(`${translationLanguage} subtitles ready.`)
    } catch (reason) {
