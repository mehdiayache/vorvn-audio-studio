...
const profile: VoiceProfile = {
  ...
  available_routes: [{ provider: "alibaba", engine: "audio", tier: "flash", model_id: "audio-flash", label: "Qwen Audio · Flash", role: "Expressive", language: "en", source_language_documented: true, documented_output_languages: ["English"], estimated_creation_cost: 0 }],
}
