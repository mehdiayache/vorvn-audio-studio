...
import { VoiceMethodPicker } from "@/features/creator/speech/voice-method-picker"
import { VoicePicker } from "@/components/voice-picker"
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select"
import { outputLanguageOptions } from "@/lib/voice-capabilities"
import { resolveSelectedRoute, routeSelection, routeSelectionId, type RouteSelection } from "@/lib/creator-contract"
...
export type SpeechRecordingSetupValue = {
  identityId: string
  route: RouteSelection | null
  language: string
}

export function resolveSpeechRecordingSetup(directory: VoiceDirectory, value: SpeechRecordingSetupValue) {
...
export function SpeechRecordingSetup({ value, config, directory, playingKey, playerPlaying, onPlay, onChange, compact = false }: {
  value: SpeechRecordingSetupValue
  config: StudioConfig | null
  directory: VoiceDirectory
  playingKey?: string
  playerPlaying: boolean
  onPlay: (source: PlayerSource) => void
  onChange: (value: SpeechRecordingSetupValue) => void
  compact?: boolean
}) {
  ...
  return <div className="recording-setup">
    ...
    <div className="recording-methods"><span>Exact recording method</span>{resolved.identity
