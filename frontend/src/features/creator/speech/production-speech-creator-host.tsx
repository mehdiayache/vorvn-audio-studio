...
export function ProductionSpeechCreatorStage(props: SpeechCreatorSurfaceProps) {
  return <div className="production-creator-stage"><SpeechCreatorSurface {...props} presentation="stage" visible /></div>
}

export function ProductionSpeechCreatorSession({ target, presentation, onExpand, onClose, ...props }: SpeechCreatorSurfaceProps & {
...
export function ProductionSpeechCreatorDialog({ title, description, onClose, ...creatorProps }: SpeechCreatorSurfaceProps & { title: string; description: string; onClose: () => void }) {
  return <Dialog open onOpenChange={(open) => { if (!open) onClose() }}>
    <DialogContent className="production-creator-dialog" showCloseButton={false}>
...
export function MobileProductionSpeechCreatorSheet({ title, description, onClose, ...creatorProps }: SpeechCreatorSurfaceProps & { title: string; description: string; onClose: () => void }) {
