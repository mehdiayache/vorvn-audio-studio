...
export function SubtitleCreatorPage({ embedded = false, panelOnly = false, onLibraryChange }: { embedded?: boolean; panelOnly?: boolean; onLibraryChange?: () => void | Promise<void> } = {}) {
  ...
  return <Root className="subtitle-creator-page" data-embedded={embedded || undefined}>
    ...
    <div className={`subtitles-layout${panelOnly ? " is-panel-only" : ""}`}><div className="subtitles-main">
