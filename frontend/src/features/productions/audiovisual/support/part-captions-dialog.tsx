...
import "@/features/productions/audiovisual/support/production-inspector.css"

export function PartCaptionsDialog({ productionId, part, directory, onOpenChange, onChanged }: {
  productionId: number
