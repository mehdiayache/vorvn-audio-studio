...
export function DeleteProductionDialog({ production, open, onOpenChange, onDeleted }: {
  ...
  async function remove() {
    setDeleting(true)
    try {
      await originsApi.deleteProduction(production!.id)
  ...
  return <DeleteConfirmationDialog
    ...
    description="Creative Production content, recordings, captions, previews and exports are permanently removed. Content-free provider operation and spend evidence remains in Activity. Reusable Workspace Files and Voices remain."
