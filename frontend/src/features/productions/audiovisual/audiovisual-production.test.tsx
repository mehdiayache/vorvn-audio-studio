...
import { TimelineWorkspace } from "@/features/productions/audiovisual/timeline/timeline-workspace"
...
describe("Production Workstation", () => {
  ...
  it("productions actual Production timing into distinct sound tracks", () => {
    const parts = [
