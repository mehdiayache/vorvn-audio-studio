...
export function WorkstationPartInspector({ productionId, part, directory, playingKey, playerPlaying, onChanged, onPlay, onEdit, onDuplicate, onDelete, onOpenCaptions, onReplaceFile }: {
  productionId: number
  part: ProductionPart
  ...
  onReplaceFile: (part: ProductionPart) => void
}) {
