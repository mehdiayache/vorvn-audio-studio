import { AlertTriangle, CircleDollarSign, Clock3, RefreshCw } from "lucide-react"
...
export function ActivityPage() {
  ...
  return <main className="activity-page">
    <header className="activity-header"><div><span><CircleDollarSign /></span><div><small>Operations and spend</small><h1>Activity</h1><p>Every provider operation remains here even when its editable output is removed.</p></div></div><Button variant="outline" onClick={() => void refresh()}><RefreshCw /> Refresh</Button></header>
    ...
    <p className="activity-accounting-note">Recorded cost combines provider-reported usage, catalogue calculations and historical estimates. Open any operation to see its basis; it is not an Alibaba invoice.</p>
