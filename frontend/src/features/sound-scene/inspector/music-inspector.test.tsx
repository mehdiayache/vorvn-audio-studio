...
describe("AudioClipInspector", () => {
  it("commits exact mix values and keeps audition separate", async () => {
    ...
    const onPlay = vi.fn()
    render(<AudioClipInspector track={track} clip={clip} playing={false} onPlay={onPlay} onClipChange={onClipChange} onClipCommit={onClipCommit} onTrackVolumeChange={vi.fn()} onTrackVolumeCommit={vi.fn()} onChoose={vi.fn()} onRemove={vi.fn()} />)
  ...
  it("keeps a failed save visible in the owning Workbench", async () => {
    ...
    render(<AudioClipInspector track={track} clip={clip} playing={false} onPlay={vi.fn()} onClipChange={vi.fn()} onClipCommit={onClipCommit} onTrackVolumeChange={vi.fn()} onTrackVolumeCommit={vi.fn()} onChoose={vi.fn()} onRemove={vi.fn()} />)
  ...
  it("does not project sequential Part language onto an empty Audio Track", () => {
    render(<AudioClipInspector track={{ ...track, clips: [] }} clip={null} playing={false} onPlay={vi.fn()} onClipChange={vi.fn()} onClipCommit={vi.fn()} onTrackVolumeChange={vi.fn()} onTrackVolumeCommit={vi.fn()} onChoose={vi.fn()} onRemove={vi.fn()} />)
  ...
  it("locks editing geometry without locking mix controls", () => {
    render(<AudioClipInspector track={track} clip={{ ...clip, locked: true }} playing={false} onPlay={vi.fn()} onClipChange={vi.fn()} onClipCommit={vi.fn()} onTrackVolumeChange={vi.fn()} onTrackVolumeCommit={vi.fn()} onChoose={vi.fn()} onRemove={vi.fn()} />)
