...
describe("MusicInspector", () => {
  ...
  it("keeps a failed save visible in the owning Workbench", async () => {
    ...
    render(<MusicInspector track={track} clip={clip} playing={false} onPlay={vi.fn()} onClipChange={vi.fn()} onClipCommit={onClipCommit} onTrackVolumeChange={vi.fn()} onTrackVolumeCommit={vi.fn()} onChoose={vi.fn()} onRemove={vi.fn()} />)
