...
import { attachmentRoleLabel, type MediaAttachmentKind, type MediaAttachmentRole, type MediaOperationCapability } from "./media-composer-config"

export type MediaComposerAttachment = {
  id: string
  name: string
...
function VisualSlot({ slot, attachment, onAdd, onPreview, onRemove }: {
  slot: InputSlot
  attachment?: MediaComposerAttachment
  onAdd?: (role: MediaAttachmentRole) => void
  onPreview: (attachment: MediaComposerAttachment) => void
  onRemove: (attachment: MediaComposerAttachment) => void
}) {
...
export function MediaComposerAttachments({ capability, attachments, onAdd, onRemove, onSwapFrames }: {
  ...
  const [previewAttachment, setPreviewAttachment] = useState<MediaComposerAttachment | null>(null)
