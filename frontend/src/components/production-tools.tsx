...
export function ProductionToolDialog({ open, nextPartNumber, insertAt, assets, assetCollectionIds, playingKey, playerPlaying, onClose, onAddSilence, onInsertAsset, onSetMusic, onUploadAsset, onPlay }: {
  ...
  const title = open === "silence" ? "Add silence" : assetMode === "music" ? "Choose music" : "Choose library audio"
