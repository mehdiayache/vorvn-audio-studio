...
export function SequenceWorkspace({ parts, cast, liveJobs, selected, visiblePartIds, filtersActive = false, activePartId, playingKey, playerPlaying, previewPlayingPartId, directory, onSelected, onClearFilters, onInsert, onRetryJob, onConfirmJob, onReplaceAsset, actions }: {
