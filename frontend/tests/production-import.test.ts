...
describe("Production import decode", () => {
  it("preserves authored JSON verbatim for backend validation", () => {
    const source = { schema: "audio-studio-production-import", version: 1, title: "A deliberate scene", description: "Test", language: "English", items: [{ type: "speech", role: "narrator", text: "The harbor woke before dawn." }] }
