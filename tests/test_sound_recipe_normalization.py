"""Sound Recipe free-language normalization stays durable and bounded."""
...
class SoundRecipeNormalizationTests(unittest.TestCase):
    def service(self, provider):
        operations = FakeProviderOperationsRepository()
        return SoundRecipeNormalizationService(
