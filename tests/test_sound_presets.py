"""Deterministic acceptance for the Sound Preset semantic layer."""
...
from origins.domain.sound_preset_taxonomy import INDEX, TAXONOMY


class SoundPresetCompilerTests(unittest.TestCase):
    ...
    def test_spoken_story_does_not_invent_context_or_tempo(self):
        result = compile_sound_preset("music", {
    ...
    def test_conflicting_brief_blocks_until_operator_resolves_it(self):
        ...
        unresolved = compile_sound_preset("music", state)
        ...
        resolved = compile_sound_preset("music", state)
    ...
    def test_sfx_uses_its_own_schema_and_format_signal(self):
        result = compile_sound_preset("sfx", {
