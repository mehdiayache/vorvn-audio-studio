...
`db.py` persistence responsibilities for canonical Work lifecycle and
Production editor, timeline, render and media operations. Venture Asset
libraries and uploads are native.
