...
test("opens an audiovisual Project and renders Timeline and Visuals without browser warnings", async ({ page, request }) => {
  ...
  await page.getByRole("button", { name: "Visuals · Create and collect visuals" }).click()
